...
namespace ebookshopping.Models
{
    public class usersaccountsController : Controller
    {
        ...
        public usersaccountsController(ebookshoppingContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.usersaccounts != null ? 
                          ...
                          Problem("Entity set 'ebookshoppingContext.usersaccounts'  is null.");
        }
        ...
        {
            SqlConnection conn1 = new SqlConnection("Data Source=DESKTOP-R6T8BRE\\SQLEXPRESS;Initial Catalog=ebookshopping;Integrated Security=True;Connect Timeout=30");
            string sql;
