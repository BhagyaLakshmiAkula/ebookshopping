...
namespace ebookshopping.Controllers
{
    public class ordersController : Controller
    {
        private readonly ebookshoppingContext _context;

        public ordersController(ebookshoppingContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.orders != null ? 
                          ...
                          Problem("Entity set 'ebookshoppingContext.orders'  is null.");
        }
       ...
       public async Task<IActionResult>create (int ? id)
        ...
        public async Task<IActionResult> Create(int bookId, int quantity)
        {
            ...
            SqlConnection conn = new SqlConnection("Data Source=DESKTOP-R6T8BRE\\SQLEXPRESS;Initial Catalog=ebookshopping;Integrated Security=True; Connect Timeout=30");
            string sql;
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ebookshoppingContext.orders'  is null.");
            }
            var orders = await _context.orders.FindAsync(id);
            if (orders != null)
            {
